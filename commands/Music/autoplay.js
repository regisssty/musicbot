...
module.exports = class extends Command {
    ...
    constructor(...args) {
        super(...args, {
            ...
            extendedHelp: [
                'NOTE! This command does not play a song from the nowhere, it tells bot whether to play the first',
                'non-duplicated (in a range of 10 songs) song from the related videos she has fetched in the latest added song.',
                'That is to say, bot receives a list of 10-15 related songs, she also saves the 10 previous played songs. If',
